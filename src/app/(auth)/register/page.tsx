...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] flex items-center justify-center overflow-hidden py-8">
      {/* Animated grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#00ff9d06_1px,transparent_1px),linear-gradient(to_bottom,#00ff9d06_1px,transparent_1px)] bg-[size:40px_40px]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_0%,rgba(0,255,157,0.05),transparent)]" />

      {/* Particles */}
      {[...Array(10)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-1 h-1 bg-[#00ff9d] rounded-full opacity-20"
      ...
      <motion.div
        ...
        className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00ff9d]/15 to-transparent pointer-events-none"
      />
      ...
      >
        <div className="absolute -inset-[1px] bg-gradient-to-b from-[#00ff9d]/25 via-[#00ff9d]/5 to-transparent rounded-2xl blur-sm" />
        ...
        <div className="relative bg-[#0d0d0d]/95 backdrop-blur-xl border border-[#00ff9d]/15 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            >
              <Dna className="w-7 h-7 text-[#00ff9d]" />
            </motion.div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[10px] font-mono text-[#00ff9d]/40 tracking-widest">
              NUEVO ACCESO
            </span>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div key={field.id} className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#111]/80 border border-white/10 text-white text-sm font-mono px-4 py-3 rounded-xl outline-none placeholder:text-gray-700 focus:border-[#00ff9d]/50 focus:shadow-[0_0_12px_rgba(0,255,157,0.08)] transition-all duration-300 pr-12"
                  />
                  {field.showToggle && (
                    <button
                      type="button"
            ...
            >
              <div className="absolute -inset-[1px] bg-gradient-to-r from-[#00ff9d] to-emerald-400 rounded-xl opacity-60 group-hover:opacity-90 transition-opacity duration-300 blur-[2px]" />
